...
excel_geopackage = r"NAVN PÅ DIN EXCEL GEOPACKAGE FIL HER"
...
def fjern_overlapp_vegobjekt(vegobjekt):
    ...
    for header, gruppe in vegobjekt.groupby("veglenkesekvensid"):
        ...
        for _, rad in gruppe.iterrows():
            ...
            ny_rad["sluttposisjon"] = rad["sluttposisjon"]
...
def kopier_felt_ved_overlapp_klipp_geometri(source, target, felt):
    """
    ...
    for _, t in df_target.iterrows():
        ...
        kandidater = df_source.loc[grupper_source.groups[header]]
        overlapp = kandidater[
            (kandidater["from_m"] <= t_to) &
            (kandidater["to_m"] >= t_from)
        ]
...
def invert_segments(base_from, base_to, segments):
    """
...
def finn_overlapp_klipp_geometri(vegobjekt1, vegobjekt2, modus="fjern"):
    ...
    for _, r1 in df1.iterrows():
        ...
        overlapp = kandidater[
            (kandidater["from_m"] <= v_to) &
            (kandidater["to_m"] >= v_from)
        ]
        ...
        if modus == "behold":
            ...
            delsegmenter = invert_segments(v_from, v_to, overlapp_segs)
...
mask = FMO["Etableringsår"].isna() & FMO["Etableringsår_excel"].notna()

FMO.loc[mask, "Etableringsår"] = FMO.loc[mask, "Etableringsår_excel"]

FMO = FMO.drop(columns=["ID", "Etableringsår_excel"])

atk = gpd.read_file(geopackage, layer="ATK_influensstrekning_775_LineString").to_crs(25833)

FMO_u_atk = finn_overlapp_klipp_geometri(FMO, atk, "fjern")
FMO_u_atk.to_file(geopackage, layer="FMO_u_ATK", driver="GPKG")   
print("FMO_u_ATK")
...
FMO_2felts_u_atk = finn_overlapp_klipp_geometri(FMO_u_atk, felt_2, "behold")
FMO_2felts_u_atk.to_file(geopackage, layer="FMO_2felts_u_atk", driver="GPKG")   
print("FMO_2felts_u_atk") 
...
FMO_2felts_u_atk_midtrekkverk = finn_overlapp_klipp_geometri(FMO_2felts_u_atk, midtdeler_midtrekkverk, "fjern")
FMO_2felts_u_atk_midtrekkverk.to_file(geopackage, layer="FMO_2felts_u_atk_midtrekkverk", driver="GPKG")  
print("FMO_2felts_u_atk_midtrekkverk")

motorveg = gpd.read_file(geopackage, layer="Motorveg_595_LineString").to_crs(25833)
FMO_2felts_u_atk_midtrekkverk_motorveg = finn_overlapp_klipp_geometri(FMO_2felts_u_atk_midtrekkverk, motorveg, "fjern")
FMO_2felts_u_atk_midtrekkverk_motorveg.to_file(geopackage, layer="FMO_2felts_u_atk_midtrekkverk_motorveg", driver="GPKG")
print("FMO_2felts_u_atk_midtrekkverk_motorveg")

vegbredde = gpd.read_file(geopackage, layer="Vegbredde_beregnet_838_LineString").to_crs(25833)
FMO_2felts_dekkebredde_u_atk_midtrekkverk_motorveg = kopier_felt_ved_overlapp_klipp_geometri(vegbredde, FMO_2felts_u_atk_midtrekkverk_motorveg, "Dekkebredde")
FMO_2felts_dekkebredde_u_atk_midtrekkverk_motorveg.to_file(geopackage, layer="FMO_2felts_dekkebredde_u_atk_midtrekkverk_motorveg", driver="GPKG")
print("FMO_2felts_dekkebredde_u_atk_midtrekkverk_motorveg")

adt  = gpd.read_file(geopackage, layer="Trafikkmengde_540_LineString").to_crs(25833)
print(adt.columns.tolist())
FMO_2felts_dekkebredde_u_atk_midtrekkverk_motorveg = kopier_felt_ved_overlapp_klipp_geometri(adt, FMO_2felts_dekkebredde_u_atk_midtrekkverk_motorveg, "ÅDT, total")
FMO_2felts_dekkebredde_u_atk_midtrekkverk_motorveg = kopier_felt_ved_overlapp_klipp_geometri(adt, FMO_2felts_dekkebredde_u_atk_midtrekkverk_motorveg, "År, gjelder for")
FMO_2felts_dekkebredde_u_atk_midtrekkverk_motorveg.to_file(geopackage, layer="FMO_2felts_dekkebredde_u_atk_midtrekkverk_motorveg", driver="GPKG")

fart = gpd.read_file(geopackage, layer="Fartsgrense_105_LineString").to_crs(25833)

FMO_2felts_dekkebredde_u_atk_midtrekkverk_motorveg = kopier_felt_ved_overlapp_klipp_geometri(fart, FMO_2felts_dekkebredde_u_atk_midtrekkverk_motorveg, "Fartsgrense")
FMO_2felts_dekkebredde_u_atk_midtrekkverk_motorveg.to_file(geopackage, layer="FMO_2felts_dekkebredde_u_atk_midtrekkverk_motorveg", driver="GPKG")

FMO_2felts_dekkebredde_u_atk_midtrekkverk_motorveg = gpd.read_file(geopackage, layer="FMO_2felts_dekkebredde_u_atk_midtrekkverk_motorveg")
ulykker = gpd.read_file(geopackage, layer="Trafikkulykke_570_Point").to_crs(25833)
ulykker = ulykker[ulykker["Stedsforhold"] == "Vegstrekning utenfor kryss/avkjørsel"]
ulykker = legg_til_alvorlighetsgrad_fra_filer(
    gdf=ulykker,
    id_gdf="nvdbId",
    dod_path=excel_geopackage + r"\Trafikkulykke_570-sensitiv-dodsulykke.csv",
    mas_path=excel_geopackage + r"\Trafikkulykke_570-sensitiv-MAS.csv",
    as_path=excel_geopackage + r"\Trafikkulykke_570-sensitiv-AS.csv",
    id_csv="OBJ.VEGOBJEKT-ID"
)

ulykker.to_file(geopackage, layer="ulykker_dekkebredde_alvorlighetsgrad_fartsgrense_influensstrekning_midtrekkverk", driver="GPKG")
FMO_2felts_dekkebredde_u_atk_midtrekkverk_motorveg = gpd.read_file(geopackage, layer="FMO_2felts_dekkebredde_u_atk_midtrekkverk_motorveg")
ulykker = gpd.read_file(geopackage, layer="ulykker_dekkebredde_alvorlighetsgrad_fartsgrense_influensstrekning_midtrekkverk")
vegopp_med_tall, ulykker_filtrert = finn_nvdbulykker_langs_objekt(geopackage, FMO_2felts_dekkebredde_u_atk_midtrekkverk_motorveg, ulykker, navn  = "FMO_2felts_dekkebredde_u_atk_midtrekkverk_motorveg")
